...
# ── Datasets ──────────────────────────────────────────────────────────────────
# "arff_name" es el nombre real del fichero en datasets/
# "dataset_name" es el nombre corto para el CSV
...
DATASETS_CONFIG = [
    ...
    {"dataset_name": "simple_dummy",      "arff_name": "simple_dummy",                   "best_scaler": StandardScaler, "best_distance": "hausdorff",      "best_eps": 0.1303,   "best_min_pts": 2},
