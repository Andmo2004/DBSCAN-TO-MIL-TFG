...
class MIKnn:
    ...
    def fit_predict(self, train_dataset: MIData, test_dataset: MIData) -> Dict[str, int]:
        """
        Entrena el modelo y predice en un único paso.
 
        :param train_dataset: MIData de entrenamiento.
        :param test_dataset:  MIData de test.
        :returns:             Diccionario {bag_id: clase_predicha}.
        """
